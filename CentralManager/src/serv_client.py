...
if __name__ == "__main__":
    ...
    thread = Thread(target = TCP_Client.recieve , args = (TCP_Client.serv_sock , )) #creates the thread to collect the data
    thread_comm = Thread(target = TCP_Client.commands , args = (TCP_Client.serv_sock , ))
