...
uint32_t status, cmd_flag, command, empty, nominal, retransition, inv_flag, hexTuint ;
char buffer [256], Rx_indx, Rx_data[2], Rx_Buffer[100], Tx_Buffer[100], Marionette[30], marionette_data[120] ;
...
static uint32_t MAR_DATA_CHECK = 8;
