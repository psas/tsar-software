...
//
//	This file contains methods for the LOX_BOILOFF
//  state.
//  LoxBoiloff has two verification Methods
...
uint32_t LoxBoiloff(struct StateVars *ctrl)
{
    ...
    {
    	if((ctrl->currentState & LOX_BOILOFF) == LOX_BOILOFF){
    		...
    		Get_State_Disagree_Error_Msg(TxMessageBuffer1, LOX_BOILOFF, ctrl->currentState);
