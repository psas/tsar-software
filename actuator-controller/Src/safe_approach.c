...
//
//	This file contains methods for the SAFE_APPROACH
//  state.
//  SafeApproach has two verification Methods
...
uint32_t SafeApproach(struct StateVars *ctrl)
{
    ...
    {
    	if((ctrl->currentState & SAFE_APPROACH) == SAFE_APPROACH){
    		...
    		ctrl->currentState =SAFE_APPROACH;
    		...
    		Get_State_Disagree_Error_Msg(TxMessageBuffer1, SAFE_APPROACH, ctrl->currentState);
    		UART_SendMessage(&hlpuart1,TxMessageBuffer1);
